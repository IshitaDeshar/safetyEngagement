...
import Wrapper from "../../AdminWrappers/AdminProfile";
...
import {
  ...
  logout,
  updateUser,
} from "../../AdminDashComponent/helpers";
...
const AdminProfile = ({ navigate }) => {
  ...
  // const { name, email, phone, address, password, cpassword, buttonText, role } =
  //   values;
  ...
  //       Authorization: `Bearer ${token}`,
  //     },
  //     data: { name, phone, address, password, role },
  //   })
  //     .then((response) => {
